...
const rotate = (dir, amount) => {
    var compassDir = toCompassDir(dir);
    var rotateCompassDir = rotateArr[(rotateArr.indexOf(compassDir) + amount + 8) % 8];
...
export {reflect, getDir, rotate, toCoordinateDir, toCompassDir, goto, sqDist};