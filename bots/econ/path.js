...
import {dist, is_valid, getClearLocations, getNearbyRobots} from './utils.js'
...
export function move_away(self, enemies) {
  ...
  for (let enemy of enemies) {
    ...
    let max_radius = enemy.unit == SPECS.PREACHER ? 50 : enemy.unit == SPECS.CASTLE ? 90 : SPECS.UNITS[enemy.unit].VISION_RADIUS;
